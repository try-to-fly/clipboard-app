      ...
      <section className="container mx-auto px-4 pt-20 pb-16 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6">
            智能剪切板管理
            <span className="block text-primary mt-2">让复制粘贴更高效</span>
          </h1>
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            免费开源的 macOS 剪切板管理工具，实时监听、智能识别、来源追踪，
            提供现代化的剪切板管理体验
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Link
              href="https://github.com/try-to-fly/clipboard-app/releases/latest"
              target="_blank"
            ...
            <Link
              href="https://github.com/try-to-fly/clipboard-app"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <h3 className="font-semibold">Clipboard App</h3>
